...
namespace Digger
{
    public class Monster : ICreature
    {
        ...
        {
            if (GetPlayerCoordinates()[0] == -1)
                return new CreatureCommand();
            var playerX = GetPlayerCoordinates()[0];
            var playerY = GetPlayerCoordinates()[1];
            var moveX = GetMoving(x, y, playerX, playerY)[0];
            var moveY = GetMoving(x, y, playerX, playerY)[1];
